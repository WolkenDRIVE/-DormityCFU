<%@ Page Title="Добавление данных для комнаты" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddRoom.aspx.cs" Inherits="DormityCFU.Pages.RoomDate.AddRoom" %>
